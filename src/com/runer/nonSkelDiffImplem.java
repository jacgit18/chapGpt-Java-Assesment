...
public class nonSkelDiffImplem {
    private static final Logger logger = Logger.getLogger(nonSkelDiffImplem.class.getName());
...
//                        .toList();
        ...
        nonSkelDiffImplem.class.getMethods()[0].getAnnotation(SuppressWarnings.class);
    }
}
